                ...
                <div class="uk-container">
                    ...
                    <router-link to="/" style="text-decoration: none;">
                      <a>Trang chủ</a>
                            ...
                            <h1 class="uk-margin-small-top uk-margin-remove-bottom">Thương hiệu</h1>
                        </div>
                        <div>
                            <div class="uk-card uk-card-default tm-ignore-container">
                                ...
                                <section class="uk-card-body" id="D">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">D</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
                                ...
                                <section class="uk-card-body" id="H">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">H</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
                                ...
                                <section class="uk-card-body" id="I">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">I</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
                                ...
                                <section class="uk-card-body" id="L">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">L</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
                                ...
                                <section class="uk-card-body" id="M">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">M</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
                                ...
                                <section class="uk-card-body" id="S">
                                    <div uk-grid>
                                        <div class="uk-width-1-1 uk-width-1-6@m">
                                            <h2 class="uk-text-center">S</h2>
                                        </div>
                                        <div class="uk-width-1-1 uk-width-expand@m">
                                            <ul class="uk-grid-small uk-child-width-1-2 uk-child-width-1-4@s uk-child-width-1-5@m" uk-grid>
                                                <li>
